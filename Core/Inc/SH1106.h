...
extern C {
   ...
   *
   * It also allows you to draw texts and characters using appropriate functions
  provided in library.
   *
   * Default pinout
   *
...
#define SH1106_HEIGHT 64
   ...
   * @note   @ref SH1106_UpdateScreen() must be called after that in order to
   ...
   * value of @ref SH1106_COLOR_t enumeration
   * @retval None
   */
   ...
   * @note   @ref SH1106_UpdateScreen() must called after that in order to see
   * updated LCD screen
   ...
   * @param  color: Color used for drawing. This parameter can be a value of
   * @ref SH1106_COLOR_t enumeration
   ...
   * @retval None
   */
  void SH1106_DrawFilledRectangle(uint16_t x, uint16_t y, uint16_t w,
                                  uint16_t h, SH1106_COLOR_t c);

  /**
   * @brief  Draws triangle on LCD
   * @note   @ref SH1106_UpdateScreen() must be called after that in order to
   * see updated LCD screen
   * @param  x1: First coordinate X location. Valid input is 0 to SH1106_WIDTH -
   * 1
   * @param  y1: First coordinate Y location. Valid input is 0 to SH1106_HEIGHT
   * - 1
   * @param  x2: Second coordinate X location. Valid input is 0 to SH1106_WIDTH
   * - 1
   * @param  y2: Second coordinate Y location. Valid input is 0 to SH1106_HEIGHT
   * - 1
   * @param  x3: Third coordinate X location. Valid input is 0 to SH1106_WIDTH -
   * 1
   * @param  y3: Third coordinate Y location. Valid input is 0 to SH1106_HEIGHT
   * - 1
   * @param  c: Color to be used. This parameter can be a value of @ref
   * SH1106_COLOR_t enumeration
   * @retval None
   ...
   * @note   @ref SH1106_UpdateScreen() must be called after that in order to
   * see updated LCD screen
   * @param  x: X location for center of circle. Valid input is 0 to
   * SH1106_WIDTH - 1
   * @param  y: Y location for center of circle. Valid input is 0 to
   * SH1106_HEIGHT - 1
...
#define SH1106_I2C_TIMEOUT 20000
   ...
   * @param  *I2Cx: I2C used
   * @param  address: 7 bit slave address, left aligned, bits 7:1 are used, LSB
   * bit is not used
